...
it('can add the star name and star symbol properly', async() => {
    ...
    assert.equal(await instance.name(), 'Life With Crypto Coin');
    assert.equal(await instance.symbol(), "LWC");
});
...
it('lets 2 users exchange stars', async() => {
    ...
    await instance.createStar('Awesome Star2!', starId2, {from: accounts[1]});
...
it('lookUptokenIdToStarInfo test', async() => {
    ...
    assert.equal(tokenName, 'Awesome Star!');
});